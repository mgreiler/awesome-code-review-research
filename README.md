...
- [Primers or Reminders? The Effects of Existing Review Comments on Code Review](https://doi.org/10.1145/3377811.3380385) — Baum et al., *ICSE*, 2020. **PR · Controlled experiment with 85 developers · ★★ · Tags: cognitive bias, existing comments, defect detection.** Finds that existing comments generally acted as useful reminders rather than harmful anchors, especially for unusual defect types.
